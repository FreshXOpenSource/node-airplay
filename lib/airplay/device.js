...
Device.prototype.showImageFile = function(file, dissolve, callback) {
        var self=this;
        ...
        readStream.on('end', function(err) {
            self.showImageBuffer(data,dissolve,0);
        });
};
...
Device.prototype.startSlideshow = function(callback){
   var data =
    ...
    this.client_.put('/slideshow/1', data, {
...
Device.prototype.showImageBuffer = function(data, transition, callback) {
...
//      "Dissolve"
  ...
  this.client_.put('/photo', data, {
        'X-Apple-Transition': 'transition',
        'X-Apple-AssetKey': '1bd6ceeb-fffd-456c-a09c-996053a7a08c'
    }, function(res) {
    if (callback) {
      callback(res ? {} : null);
    }
